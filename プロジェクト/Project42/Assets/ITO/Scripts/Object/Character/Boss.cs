...
public class Boss : BeDestroyedObject
{
   ...
   // private FormBossStageObject formBossStageObject;
    ...
    {
        AudioManager.Instance.PlaySE(AUDIO.SE_BOSSSTART);
        yield return new WaitForSeconds(0.5f);
        AudioManager.Instance.PlaySE(AUDIO.SE_BOSSROLE);
        yield return new WaitForSeconds(2f);
        AudioManager.Instance.PlaySE(AUDIO.SE_BOSSCOMBI);
        yield return new WaitForSeconds(1f);
        GetComponent<FormBossStageObject>().InitFormSheildEnemy();
        shield.GetComponent<ParticleSystem>().Play();

       // yield return new WaitForSeconds(1f);
        isAppearedInDirectorEnd = true;
        FindObjectOfType<GamePlayEvent>().SetPlayerEnabled(true);
        GetComponent<FormBossStageObject>().InitFormNormalEnemy();
        AudioManager.Instance.PlayBGM(AUDIO.BGM_BOSS);
    }
